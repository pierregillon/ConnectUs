...
#line hidden
        ...
        public virtual void TestInitialize()
        {
            ...
            {
                ConnectUs.Core.Tests.BDD.Features.ProcessRequestsOnClientSideFeature.FeatureSetup(null);
            }
        }
...
#line 16
 testRunner.Then("I get the message \"{\"Code\":404,\"Message\":\"The request \'unknownRequest\' is unknown" +
                    ".\",\"Name\":\"ErrorResponse\"}\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
        
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Execute known request that throw exception on the client returns correct error.")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "ProcessRequestsOnClientSide")]
        public virtual void ExecuteKnownRequestThatThrowExceptionOnTheClientReturnsCorrectError_()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Execute known request that throw exception on the client returns correct error.", ((string[])(null)));
#line 18
this.ScenarioSetup(scenarioInfo);
#line 19
 testRunner.Given("A mocked command locator", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line 20
  testRunner.And("A client request processor", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 21
 testRunner.When("I process the request \"{\"Name\":\"throwErrorRequest\"}\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 22
 testRunner.Then("I get the message \"{\"Code\":-1,\"Message\":\"An error occured!\",\"Name\":\"ErrorResponse" +
