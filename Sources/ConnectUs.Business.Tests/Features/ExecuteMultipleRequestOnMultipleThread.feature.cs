...
#line 48
 testRunner.When("I start the continous client request process to process incoming request", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 49
  testRunner.And("I upload file \'Resources/file.txt\' to \'Resources/Uploaded/\' through the server re" +
                    "quest processor", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 50
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Upload file through the server request processor with no directory name set new f" +
            "ile in the current directory")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "ExecuteMultipleRequestOnMultipleThread")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("ConcurrentRequestExecution")]
        public virtual void UploadFileThroughTheServerRequestProcessorWithNoDirectoryNameSetNewFileInTheCurrentDirectory()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Upload file through the server request processor with no directory name set new f" +
                    "ile in the current directory", ((string[])(null)));
#line 53
this.ScenarioSetup(scenarioInfo);
#line 7
this.FeatureBackground();
#line 54
 testRunner.When("I start the continous client request process to process incoming request", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 55
  testRunner.And("I upload file \'Resources/file.txt\' to \'\' through the server request processor", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 56
